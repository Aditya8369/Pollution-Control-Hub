...
const QUIZ_SETS = {
  "eco-iq": {
    ...
    questions: [
      {
        question:
          "Which pollutant is most strongly linked with deep lung penetration?",
        options: ["PM10", "PM2.5", "Ozone", "Sulfur dioxide"],
        answer: "PM2.5",
        explanation:
          "PM2.5 particles can reach deep into lungs and enter the bloodstream.",
      },
      {
        ...
        answer: "101-150",
        explanation:
          "AQI 101-150 affects children, elderly, and asthma patients most.",
      },
      {
        ...
        explanation:
          "Shared mobility reduces per-person emissions significantly.",
      },
      {
        ...
        options: [
          ...
          "Continue normally",
          "Move indoors",
          "Exercise near traffic",
        ],
        answer: "Move indoors",
        explanation:
          "Reduced outdoor exertion lowers harmful pollutant inhalation.",
      },
      {
  ...
  "pollution-busters": {
    ...
    questions: [
      {
        question:
          "What percentage of air pollution comes from vehicles globally?",
        options: ["15%", "30%", "50%", "70%"],
        answer: "30%",
        explanation:
          "Vehicular emissions account for roughly 30% of urban air pollution.",
      },
      {
        ...
        explanation:
          "Unventilated cooking releases PM2.5 and harmful gases indoors.",
      },
      {
        ...
        options: [
          "Vehicle exhaust",
          "Factories",
          "Chemical reactions in sun",
          "Trees",
        ],
        answer: "Chemical reactions in sun",
        explanation:
          "Ozone forms from NOx and volatile organic compounds under sunlight.",
      },
      {
      ...
      },
      {
        ...
        answer: "N95 mask",
        explanation:
          "N95 masks block 95% of airborne particles including PM2.5.",
      },
    ],
  },
  "green-brain": {
    ...
    questions: [
      {
        ...
        answer: "Banyan",
        explanation:
          "Banyan trees are efficient carbon absorbers and natural air purifiers.",
      },
      {
        ...
        explanation:
          "All major renewables produce minimal pollution during operation.",
      },
      {
        ...
        explanation:
          "Active transport eliminates emissions vs. motorized travel entirely.",
      },
      {
      ...
      },
      {
        ...
        answer: "All combined",
        explanation:
          "Modern factories use multiple technologies for comprehensive control.",
      },
    ],
  },
  "clean-earth": {
    ...
    questions: [
      {
        ...
        answer: "Winter",
        explanation:
          "Winter has temperature inversions that trap pollutants near ground.",
      },
      {
        ...
        explanation:
          "Plants absorb toxins and ventilation removes stale air naturally.",
      },
      {
        ...
        answer: "SO2 and NOx",
        explanation:
          "Sulfur dioxide and nitrogen oxides react with moisture to form acid rain.",
      },
      {
        ...
        answer: "Days",
        explanation:
          "Pollutants can remain airborne for several days, traveling hundreds of km.",
      },
      {
        ...
        explanation:
          "Proper maintenance ensures efficient combustion and lower emissions.",
      },
    ],
  },
  "pollution-awareness": {
    ...
    questions: [
      {
        ...
        answer: "Delhi",
        explanation:
          "Delhi frequently ranks among the most polluted cities globally.",
      },
      {
        question: "What does AQI stand for?",
        options: [
          "Air Quality Index",
          "Atmosphere Quality Indicator",
          "Air Qty Interface",
          "Airborne Quantile Index",
        ],
        answer: "Air Quality Index",
        explanation:
          "AQI is the standard measure of air quality and pollution levels.",
      },
      {
        ...
        explanation:
          "Manufacturing industries produce the highest industrial emissions.",
      },
      {
        question: "How does smog form?",
        options: [
          "Only fog",
          "Sunlight + pollution reaction",
          "Only dust",
          "Rain effect",
        ],
        answer: "Sunlight + pollution reaction",
        explanation:
          "Smog is photochemical fog created when UV light reacts with pollutants.",
      },
      {
        ...
        explanation:
          "Young lungs and aging bodies are most vulnerable to pollution.",
      },
    ],
  },
  "save-earth": {
    ...
    questions: [
      {
        ...
        options: [
          "Buy filters",
          "Avoid chemicals and ventilate",
          "Close windows",
          "Use perfume",
        ],
        answer: "Avoid chemicals and ventilate",
        explanation:
          "Using natural and non-toxic products plus ventilation is most effective.",
      },
      {
      ...
      },
      {
        ...
        answer: "24%",
        explanation:
          "Agriculture accounts for roughly 24% of global emissions.",
      },
      {
        ...
        answer: "Solar",
        explanation:
          "Solar panels are most practical for individual home energy needs.",
      },
      {
        question: "How to protect lungs from pollution?",
        options: [
          "Avoid masks",
          "Wear masks on high AQI",
          "Smoke more",
          "Exercise always",
        ],
        answer: "Wear masks on high AQI",
        explanation:
          "N95 masks significantly reduce harmful particle inhalation.",
      },
    ],
  },
  "eco-warriors": {
    ...
    questions: [
      {
        ...
        explanation:
          "Understanding local air quality is the first step to action.",
      },
      {
        ...
        explanation:
          "Personal transport choices have immediate and visible impact.",
      },
      {
        ...
        explanation:
          "Unventilated cooking is the largest source of indoor PM2.5.",
      },
      {
        ...
        explanation:
          "Informed public pressure drives stronger environmental policies.",
      },
      {
        ...
        explanation:
          "Systemic change through collective action is the only lasting solution.",
      },
    ],
  },
  "planet-protector": {
    ...
    questions: [
      {
        ...
        explanation:
          "Transitioning to clean energy is the most impactful long-term solution.",
      },
      {
        ...
        explanation:
          "Carbon sequestration removes and stores CO2 from the atmosphere.",
      },
      {
        ...
        explanation:
          "Reduced consumption directly reduces manufacturing and transport emissions.",
      },
      {
        question: "What is environmental justice?",
        options: [
          "Ignoring pollution",
          "Equal pollution exposure for all",
          "Rich vs poor",
          "Fair environmental protection for all communities",
        ],
        answer: "Fair environmental protection for all communities",
        explanation:
          "Environmental justice ensures all communities get equal pollution protection.",
      },
      {
        ...
        answer: "Energy",
        explanation:
          "Energy sector produces largest emissions and is crucial to transition.",
      },
    ],
  },
  "climate-basics": {
    ...
    questions: [
      {
        ...
        explanation:
          "Burning fossil fuels releases CO2 and other gases that trap heat in the atmosphere.",
      },
      {
        question:
          "Which gas is the largest contributor to the greenhouse effect from human activity?",
        options: ["Oxygen", "Carbon dioxide (CO2)", "Nitrogen", "Argon"],
        answer: "Carbon dioxide (CO2)",
        explanation:
          "CO2 from burning fossil fuels is the largest driver of human-caused warming.",
      },
      {
        ...
        explanation:
          "Greenhouse gases trap solar heat, warming the planet like a greenhouse traps warmth.",
      },
      {
        ...
        explanation:
          "Melting ice adds water to oceans, raising sea levels and threatening coastal areas.",
      },
      {
        question:
          "Which action helps mitigate climate change most effectively?",
        options: [
          "Increasing coal use",
        ...
        explanation:
          "Renewable energy sources like solar and wind produce far fewer emissions than fossil fuels.",
      },
    ],
  },
};
...
function QuizSelector({ onSelectQuiz }) {
  return (
    <div className="quiz-selector">
      ...
      <p>
        Pick a challenge to test your pollution and environmental knowledge.
      </p>
...
function QuizResult({ score, total, onRestart }) {
  ...
  return (
    <div className="quiz-result">
      ...
      <p>
        {percent >= 80
          ? "Excellent! You are a pollution expert."
          : percent >= 60
            ? "Good effort! Keep learning."
            : "Keep trying and improve your knowledge."}
      </p>
    ...
    <section className="panel quiz-panel">
      <div className="panel-head">
        <div className="quiz-header-row">
          <h2>{quizSet.name}</h2>
          <button type="button" className="back-btn" onClick={restartQuiz}>
            ← Back
          </button>
        </div>
        <p>
