...
export default function AqiMissionGame({ current }) {
  ...
  const getSimulatedResults = () => {
    ...
    deployedActions.forEach((actionId) => {
      ...
      if (action.reductions.nitrogen_dioxide)
        nitrogen_dioxide *= 1 - action.reductions.nitrogen_dioxide / 100;
      if (action.reductions.ozone) ozone *= 1 - action.reductions.ozone / 100;
      if (action.reductions.carbon_monoxide)
        carbon_monoxide *= 1 - action.reductions.carbon_monoxide / 100;
    });
  ...
  const isTargetAchieved =
    currentSimResults.improvement >= selectedMission.targetImprovement;
  ...
  return (
    <section className="panel game-section" aria-labelledby="game-heading">
      <div className="panel-head">
        <h2 id="game-heading">
          <Gamepad2 className="inline-icon" size={22} aria-hidden="true" /> AQI
          Mission Control
        </h2>
        <p>
          Take charge as City Commissioner. Deploy clean-air policies within
          steps and time limits to beat the smog!
        </p>
      </div>
      ...
      {gameState === "idle" && (
        <div className="game-intro-layout">
          <div className="intro-card-primary">
            ...
            <div className="mission-grid">
              {MISSIONS.map((mission) => {
                ...
                return (
                  ...
                  >
                    <span className="mission-icon-lg">
                      <MissionIcon size={36} aria-hidden="true" />
                    </span>
                    <div className="mission-select-info">
                      <div className="mission-title-row">
                        <span className="mission-name">{mission.name}</span>
                        <span
                          className={`difficulty-badge ${mission.difficulty.toLowerCase()}`}
                        >
                          {mission.difficulty}
                        </span>
                      </div>
                      ...
                      <div className="mission-meta-row">
                        <span>
                          ...
                          />{" "}
                          Target:{" "}
                          <strong>−{mission.targetImprovement}% AQI</strong>
                        </span>
                        <span>
                          <Footprints
                            className="inline-icon"
                          ...
                          />{" "}
                          Limit:{" "}
                          <strong>{mission.allowedSteps} Policies</strong>
                        </span>
                        <span>
                          <Timer
                            className="inline-icon"
                            ...
                            aria-hidden="true"
                          />{" "}
                          Time: <strong>{mission.timerDuration}s</strong>
                        </span>
                      </div>
                    </div>
                  </button>
            ...
            <div className="mode-toggle-section">
              ...
              <div className="mode-toggle-buttons">
                ...
                <button
                  ...
                  disabled={!current}
                >
                  <Map className="inline-icon" size={16} aria-hidden="true" />{" "}
                  Live City Data (
                  {current?.us_aqi ? `AQI ${current.us_aqi}` : "Offline"})
                </button>
              </div>
            ...
            <button
              type="button"
              className="btn-primary start-mission-btn"
              onClick={handleStartMission}
            >
              <Rocket className="inline-icon" size={18} aria-hidden="true" />{" "}
              Launch Mission
            </button>
          </div>
          ...
          <div className="intro-sidebar">
            <div className="rules-card">
              ...
              <ol className="rules-list">
                <li>
                  <strong>Choose policy mix:</strong> Click cards to deploy
                  clean-air policies.
                </li>
                <li>
                  <strong>Respect your limits:</strong> You have a maximum
                  number of policies (steps) you can deploy.
                </li>
                <li>
                  <strong>Watch the clock:</strong> Evaluate your choices before
                  the timer hits 0.
                </li>
                <li>
                  <strong>Win target:</strong> Reduce the starting AQI by the
                  target percentage.
                </li>
              </ol>
              <div className="fun-tip-box">
                ...
                />{" "}
                <em>
                  Tip: Pay attention to which pollutants are highest. Choose
                  policies that target those specific pollutants!
                </em>
              </div>
            </div>
          </div>
        ...
        <div className="game-playing-layout">
          ...
          <div className="game-hud">
            <div className="hud-metric timer-box">
              ...
              <span
                className={`hud-val countdown ${timeLeft <= 10 ? "critical" : ""}`}
              >
                <Timer className="inline-icon" size={16} aria-hidden="true" />{" "}
                {timeLeft}s
              </span>
            </div>
            ...
            <div className="hud-metric target-box">
              ...
              <span className="hud-val">
                <Target className="inline-icon" size={16} aria-hidden="true" />{" "}
                −{selectedMission.targetImprovement}%
              </span>
            </div>
            ...
            <div className="hud-metric status-box">
              ...
              <span
                className={`hud-val ${isTargetAchieved ? "success-text" : "danger-text"}`}
              >
                {currentSimResults.improvement}%{" "}
                {isTargetAchieved ? (
                  <Check className="inline-icon" size={16} aria-hidden="true" />
                ) : (
                  <X className="inline-icon" size={16} aria-hidden="true" />
                )}
              </span>
            </div>
          </div>
          ...
          <div className="game-progress-wrapper">
            <div className="progress-bar-container">
              <div
                ...
                style={{
                  width: `${Math.min(100, (currentSimResults.improvement / selectedMission.targetImprovement) * 100)}%`,
                }}
              />
              <span className="progress-bar-label">
                {currentSimResults.improvement}% of{" "}
                {selectedMission.targetImprovement}% target reduced
              </span>
            </div>
          </div>
          ...
          {playMode === "live" && isScaled && (
            <div className="game-notice-banner">
              <AlertTriangle
                ...
                aria-hidden="true"
              />{" "}
              Live city air is clean today. Simulated winter smog inversion
              active (Pollutants scaled up {scaleFactor}x).
            </div>
          )}
                    ...
                    >
                      <div className="policy-header">
                        <span className="policy-icon">
                          <PolicyIcon size={22} aria-hidden="true" />
                        </span>
                      ...
                      <div className="policy-reductions-taglist">
                        {Object.entries(action.reductions).map(
                          ([pollutant, val]) => (
                      ...
                      {isDeployed && (
                        <span className="policy-deployed-stamp">ACTIVE</span>
                      )}
                    </button>
                  );
                })}
            ...
            <div className="dashboard-section">
              ...
              <div className="sim-aqi-comparison">
                <div className="sim-aqi-card baseline">
                  ...
                  <span
                    className="aqi-val"
                    style={{ color: getAQIBand(startingAqi).color }}
                  >
                    {startingAqi}
                  </span>
                  <span
                ...
                <div className="sim-aqi-card projected">
                  ...
                  <span
                    className="aqi-val"
                    style={{ color: getAQIBand(currentSimResults.aqi).color }}
                  >
                ...
                <table className="game-table">
                  ...
                  <tbody>
                    <tr className="game-row">
                      <td>PM2.5</td>
                      <td>
                        {currentPollutants.pm2_5} <small>µg/m³</small>
                      </td>
                      <td>→</td>
                      <td
                        className={
                          currentSimResults.pollutants.pm2_5 <
                          currentPollutants.pm2_5
                            ? "better"
                            : ""
                        }
                      >
                    ...
                    <tr className="game-row">
                      <td>PM10</td>
                      <td>
                        {currentPollutants.pm10} <small>µg/m³</small>
                      </td>
                      <td>→</td>
                      <td
                        className={
                          currentSimResults.pollutants.pm10 <
                          currentPollutants.pm10
                            ? "better"
                            : ""
                        }
                      >
                    ...
                    <tr className="game-row">
                      <td>NO₂</td>
                      <td>
                        {currentPollutants.nitrogen_dioxide}{" "}
                        <small>µg/m³</small>
                      </td>
                      <td>→</td>
                      <td
                        className={
                          currentSimResults.pollutants.nitrogen_dioxide <
                          currentPollutants.nitrogen_dioxide
                            ? "better"
                            : ""
                        }
                    ...
                    <tr className="game-row">
                      <td>Ozone</td>
                      <td>
                        {currentPollutants.ozone} <small>µg/m³</small>
                      </td>
                      <td>→</td>
                      <td
                        className={
                          currentSimResults.pollutants.ozone <
                          currentPollutants.ozone
                            ? "better"
                            : ""
                        }
                      >
                    ...
                    <tr className="game-row">
                      <td>CO</td>
                      <td>
                        {currentPollutants.carbon_monoxide} <small>ppb</small>
                      </td>
                      <td>→</td>
                      <td
                        className={
                          currentSimResults.pollutants.carbon_monoxide <
                          currentPollutants.carbon_monoxide
                            ? "better"
                            : ""
                        }
                      >
      ...
      {gameState === "completed" && finalStats && (
        <div className="game-completed-layout">
          <div
            className={`results-banner ${finalStats.success ? "success" : "failure"}`}
          >
            ...
            <h2>
              {finalStats.success ? "Mission Accomplished!" : "Mission Failed"}
            </h2>
          ...
          <div className="results-comparison-grid">
            <div className="results-card-metric">
              ...
              <span
                ...
                style={{ color: getAQIBand(finalStats.startingAqi).color }}
              >
                {finalStats.startingAqi}
              </span>
              <span
                className="results-band"
                style={{ color: getAQIBand(finalStats.startingAqi).color }}
              >
            ...
            <div className="results-card-metric-arrow">
              <span>→</span>
              <span className="final-reduction">
                −{finalStats.improvement}%
              </span>
            </div>
            ...
            <div className="results-card-metric">
              ...
              <span
                className="results-value"
                style={{ color: getAQIBand(finalStats.finalAqi).color }}
              >
                {finalStats.finalAqi}
              </span>
              <span
          ...
          <div className="results-debriefing">
            ...
            {finalStats.deployedActions.length === 0 ? (
              <p className="no-policies">
                No policies were deployed during this mission.
              </p>
            ) : (
                ...
                {finalStats.deployedActions.map((actionId) => {
                  ...
                  return (
                    <div key={actionId} className="deployed-policy-item">
                      <span className="policy-item-icon">
                        <PolicyIcon size={28} aria-hidden="true" />
                      </span>
          ...
          <div className="results-actions">
            <button
              ...
              onClick={handleStartMission}
            >
              <RotateCcw className="inline-icon" size={16} aria-hidden="true" />{" "}
              Try Again
            </button>
            <button
              type="button"
