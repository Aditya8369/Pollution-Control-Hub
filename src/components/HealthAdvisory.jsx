...
export default function HealthAdvisory() {
  ...
  const organImpacts = [
    {
      title: t('healthAdvisory.organs.lungs.title'),
      impact: t('healthAdvisory.organs.lungs.impact'),
      icon: (
    ...
    {
      title: t('healthAdvisory.organs.heart.title'),
      impact: t('healthAdvisory.organs.heart.impact'),
      icon: (
        <svg className="organ-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {
      title: t('healthAdvisory.organs.skin.title'),
      impact: t('healthAdvisory.organs.skin.impact'),
      icon: (
        <svg className="organ-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {
      title: t('healthAdvisory.organs.eyes.title'),
      impact: t('healthAdvisory.organs.eyes.impact'),
      icon: (
        <svg className="organ-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {
      title: t('healthAdvisory.organs.brain.title'),
      impact: t('healthAdvisory.organs.brain.impact'),
      icon: (
        <svg className="organ-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {
      title: t('healthAdvisory.organs.immune.title'),
      impact: t('healthAdvisory.organs.immune.impact'),
      icon: (
        <svg className="organ-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  const audiences = {
    general: {
      ...
      tips: [
        {
          title: t('healthAdvisory.tips.general.mask.title'),
          detail: t('healthAdvisory.tips.general.mask.detail'),
          priority: t('healthAdvisory.priorities.medium', { defaultValue: 'Medium' }),
        ...
        {
          title: t('healthAdvisory.tips.general.ventilation.title'),
          detail: t('healthAdvisory.tips.general.ventilation.detail'),
          priority: t('healthAdvisory.priorities.high', { defaultValue: 'High' }),
        ...
        {
          title: t('healthAdvisory.tips.general.exercise.title'),
          detail: t('healthAdvisory.tips.general.exercise.detail'),
          priority: t('healthAdvisory.priorities.low', { defaultValue: 'Low' }),
    ...
    sensitive: {
      ...
      tips: [
        {
          title: t('healthAdvisory.tips.sensitive.inhaler.title'),
          detail: t('healthAdvisory.tips.sensitive.inhaler.detail'),
          priority: t('healthAdvisory.priorities.high', { defaultValue: 'High' }),
          badgeClass: 'badge-danger',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {
          title: t('healthAdvisory.tips.sensitive.purifier.title'),
          detail: t('healthAdvisory.tips.sensitive.purifier.detail'),
          priority: t('healthAdvisory.priorities.high', { defaultValue: 'High' }),
          badgeClass: 'badge-danger',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {
          title: t('healthAdvisory.tips.sensitive.limit.title'),
          detail: t('healthAdvisory.tips.sensitive.limit.detail'),
          priority: t('healthAdvisory.priorities.medium', { defaultValue: 'Medium' }),
          badgeClass: 'badge-warning',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    vulnerable: {
      ...
      tips: [
        {
          title: t('healthAdvisory.tips.vulnerable.walks.title'),
          detail: t('healthAdvisory.tips.vulnerable.walks.detail'),
          priority: t('healthAdvisory.priorities.high', { defaultValue: 'High' }),
          badgeClass: 'badge-danger',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {
          title: t('healthAdvisory.tips.vulnerable.diet.title'),
          detail: t('healthAdvisory.tips.vulnerable.diet.detail'),
          priority: t('healthAdvisory.priorities.medium', { defaultValue: 'Medium' }),
          badgeClass: 'badge-warning',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {
          title: t('healthAdvisory.tips.vulnerable.play.title'),
          detail: t('healthAdvisory.tips.vulnerable.play.detail'),
          priority: t('healthAdvisory.priorities.high', { defaultValue: 'High' }),
          badgeClass: 'badge-danger',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  return (
    <section data-testid="health-advisory" className="panel health-advisory-panel">
      <div className="panel-head">
        <h2>{t('healthAdvisory.title')}</h2>
        <p>{t('healthAdvisory.subtitle')}</p>
      </div>
