    ...
    tips: [
      {
        title: "Wear a Mask",
        detail:
          "Use an N95/N99 mask during peak traffic hours or when AQI exceeds 150.",
        priority: "Medium",
      ...
      },
      {
        ...
        detail:
          "Keep windows closed when local AQI is high; open them during clean wind hours.",
        priority: "High",
      ...
      },
      {
        ...
        detail:
          "Shift intense cardio sessions indoors if the AQI rises above 100.",
        priority: "Low",
    ...
    tips: [
      {
        ...
        detail:
          "Keep prescribed quick-relief medication handy at all times when outdoors.",
        priority: "High",
        badgeClass: "badge-danger",
        icon: (
          <svg
      ...
      },
      {
        ...
        detail:
          "Keep HEPA filters active in your bedroom and workspace to reduce indoor triggers.",
        priority: "High",
        badgeClass: "badge-danger",
        icon: (
          <svg
      ...
      },
      {
        ...
        detail:
          "Avoid walking near main roads during peak congestion and early mornings.",
        priority: "Medium",
        badgeClass: "badge-warning",
        icon: (
          <svg
    ...
    tips: [
      {
        ...
        detail:
          "Air pollutants settle close to the ground in the early morning; walk in the afternoon instead.",
        priority: "High",
        badgeClass: "badge-danger",
        icon: (
          <svg
      ...
      },
      {
        ...
        detail:
          "Consume foods rich in Vitamin C, E, and Omega-3 to help combat system-wide oxidative stress.",
        priority: "Medium",
        badgeClass: "badge-warning",
        icon: (
          <svg
      ...
      },
      {
        title: "Indoor Play",
        detail:
          "Keep kids active with creative indoor activities instead of playing outdoors when AQI exceeds 100.",
        priority: "High",
        badgeClass: "badge-danger",
        icon: (
          <svg
  ...
  return (
    <section className="panel health-advisory-panel">
      <div className="panel-head">
        ...
        <p>
          How current air quality impacts your organs, and recommended steps to
          protect yourself.
        </p>
      </div>
      ...
      <div className="advisory-grid">
        {sections.map((section) => (
          <article key={section.title} className="advisory-card">
            <div className={`icon-container ${section.variant}`}>
              {section.icon}
            </div>
          ...
          {audiences[activeTab].tips.map((tip) => (
            <div key={tip.title} className="tip-action-card">
              <div className="tip-header">
                ...
                <span className={`priority-badge ${tip.badgeClass}`}>
                  {tip.priority}
                </span>
              </div>
