      ...
      {showWind && windData && (
        ...
        >
          ...
          >
            ...
            >
              Arrows indicate the direction wind is blowing.
            </span>
          </div>
          <p style={{ margin: 0, fontSize: "0.95rem" }}>
            Wind blowing {getWindDirectionText(windData.direction)} at{" "}
            {windData.speed} km/h — pollution patterns may shift in this
            direction.
          </p>
        </div>
      )}
